...
export const NARRATION_PROVIDER_SMOKE_TESTS = [
  "kokoro_narration::tests::renders_real_kokoro_audio_from_local_fixture",
...
export function narrationProviderSmokeEnvironment(environment = process.env) {
  ...
  return {
    ...environment,
    SONELLE_KOKORO_FIXTURE_ROOT: workspace,
...
function assertProviderFixtures() {
  ...
  const required = [
    ...
    join(workspace, "results", "kokoro", "native-fixture.json"),
